...
#ifdef ZK
    printf("call qemu_start_incoming_migration.\n");
#endif
...
#ifdef ZK
    printf("ret qemu_start_incoming_migration.\n");
#endif
    return ret;
}
...
{
#ifdef ZK
    printf("call process_incoming_migration.\n");
#endif
...
#ifdef ZK
    printf("ret process_incoming_migration.\n");
#endif
}
