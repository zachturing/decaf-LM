...
# Configured with: './configure' '--enable-vmi' '--enable-tcg-taint' '--disable-tcg-ir-log' '--source-path=/home/zk/DECAF/decaf'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
ARLIBS_BEGIN=
ARLIBS_END=
LIBS+=  $(SRC_PATH)/shared/sleuthkit/lib/libtsk.a -lbfd -pthread -pthread -lgthread-2.0 -lglib-2.0    -lstdc++
