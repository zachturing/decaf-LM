...
#ifdef ZK
    printf("before DECAF_callback_init().\n");
#endif
	DECAF_callback_init();

#ifdef ZK
    printf("after DECAF_callback_init().\n");
    printf("before tainting_init().\n");
#endif
	tainting_init();

#ifdef ZK
   printf("after tainting_init().\n");
   printf("before DECAF_virtdev_init().\n");
#endif 
	DECAF_virtdev_init();
#ifdef ZK
   printf("after DECAF_virtdev_init().\n");
#endif
	 ...
	 */
#ifdef ZK
    printf("before register_savevm.\n");
#endif
	register_savevm(NULL, "DECAF", 0, 1, DECAF_save, DECAF_load, NULL );
#ifdef ZK
    printf("after register_savevm.\n");
    printf("before function_map_init.\n");
#endif	
    DECAF_vm_compress_init();
	function_map_init();
#ifdef ZK
    printf("after function_map_init.\n");
#endif
	init_hookapi();
...
#else
#ifdef ZK
    printf("before VMI_init().\n");
#endif
	VMI_init();
#ifdef ZK
    printf("after VMI_init().\n");
#endif
